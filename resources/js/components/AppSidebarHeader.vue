    ...
    >
        <div class="flex items-center gap-4 flex-1 max-w-xl">
            ...
            <div class="relative flex-1 group">
                <Search class="absolute left-3 top-1/2 -translate-y-1/2 h-4 w-4 text-muted-foreground group-focus-within:text-accent transition-colors" />
                <input 
                    type="text" 
        ...
        <div class="flex items-center gap-2">
            ...
            <div class="flex items-center gap-1 pr-4 border-r border-input">
                <button class="h-9 w-9 flex items-center justify-center rounded-lg text-muted-foreground hover:bg-secondary hover:text-foreground transition-all">
                    <Zap class="h-4 w-4" />
                </button>
                <button class="h-9 w-9 flex items-center justify-center rounded-lg text-muted-foreground hover:bg-secondary hover:text-foreground transition-all">
                    <Users class="h-4 w-4" />
                </button>
                <button class="h-9 w-9 flex items-center justify-center rounded-lg text-muted-foreground hover:bg-secondary hover:text-foreground transition-all relative">
                    <Bell class="h-4 w-4" />
