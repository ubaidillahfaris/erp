            ...
            <div class="lg:col-span-5 bg-white rounded-xl border border-slate-200 overflow-hidden">
                ...
                <form @submit.prevent="submit" class="p-6 flex flex-col gap-4">
                    <div class="flex flex-col gap-2">
                        ...
                        <Input id="nama" v-model="form.nama" required placeholder="Nama Perusahaan" class="h-10 rounded-md border-input shadow-none focus-visible:ring-2 focus-visible:ring-slate-900/10 font-medium" :aria-invalid="!!form.errors.nama" />
                    ...
                    <div class="flex flex-col gap-2">
                        ...
                        <Textarea id="alamat" v-model="form.alamat" rows="2" placeholder="Alamat Operasional..." class="rounded-md border-input shadow-none focus-visible:ring-2 focus-visible:ring-slate-900/10 resize-none p-3 text-sm" :aria-invalid="!!form.errors.alamat" />
                    </div>

                    <div class="grid grid-cols-2 gap-4">
                        <div class="flex flex-col gap-2">
                            <Label for="telepon" class="text-sm font-medium text-foreground px-0.5">Telepon</Label>
                            <Input id="telepon" v-model="form.telepon" placeholder="Nomor Telepon" class="h-10 rounded-md border-input shadow-none focus-visible:ring-2 focus-visible:ring-slate-900/10 text-sm" :aria-invalid="!!form.errors.telepon" />
                        </div>
                        <div class="flex flex-col gap-2">
                            <Label for="email" class="text-sm font-medium text-foreground px-0.5">Email</Label>
                            <Input id="email" v-model="form.email" type="email" placeholder="Email (Opsional)" class="h-10 rounded-md border-input shadow-none focus-visible:ring-2 focus-visible:ring-slate-900/10 text-sm" :aria-invalid="!!form.errors.email" />
                        </div>
                    </div>

                    <div class="flex flex-col gap-2">
                        <Label for="keterangan" class="text-sm font-medium text-foreground px-0.5">Keterangan</Label>
                        <Textarea id="keterangan" v-model="form.keterangan" rows="2" placeholder="Catatan tambahan..." class="rounded-md border-input shadow-none focus-visible:ring-2 focus-visible:ring-slate-900/10 resize-none p-3 text-sm" />
                    </div>
