...
watch(searchTerm, debounce((value) => {
    ...
    router.get(`/stock-opname/${props.opname.id}/edit`, 
        { search: value }, 
...
const submit = (status: 'draft' | 'completed') => {
    ...
    if (confirm(msg)) {
        ...
        })).put(`/stock-opname/${props.opname.id}`);
    }
};
    ...
    <div class="p-6 flex flex-col gap-10">
        ...
        <div class="flex items-center justify-between border-b pb-6 border-muted rounded-none">
            <div class="flex items-center gap-4">
                ...
                <div>
                    <h1 class="text-2xl font-bold tracking-tight">Edit Draft Stock Opname</h1>
                    <p class="text-sm text-muted-foreground mt-1">Lanjutkan menginput stok fisik atau ubah data draft.</p>
                </div>
            </div>
            <div class="flex gap-3">
                <Button variant="outline" @click="submit('draft')" :disabled="form.processing" class="rounded-none border-muted">
                    <Save class="mr-2 h-4 w-4" />
                    Simpan
                </Button>
                <Button @click="submit('completed')" :disabled="form.processing" class="rounded-none bg-primary hover:bg-primary/90">
        ...
        <div class="flex flex-col gap-10">
            ...
            <section class="space-y-6">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
                    ...
                    <div class="space-y-2">
                        ...
                        <Textarea 
                            ...
                            placeholder="Misal: Opname Bulanan" 
                ...
                <div v-if="totalDiscrepancies > 0" class="flex items-center gap-3 py-3 border-y border-yellow-500/20 bg-yellow-500/5 px-2">
                                ...
                                <TableCell class="px-0 py-4 text-right">
                                    <div class="flex items-center justify-end gap-2">
                                        <Input 
                                            ...
                                            v-model="form.items_map[produk.id].physical_qty" 
                                            type="number" 
                                            step="any"
