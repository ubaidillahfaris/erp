...
const form = useForm({
    ...
    customer_status_id: undefined as number | undefined,
});
                ...
                <form @submit.prevent="submit" class="p-6 flex flex-col gap-6">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                        ...
                        <div class="flex flex-col gap-2">
                            ...
                            <Input id="phone" v-model="form.phone" placeholder="Contoh: 08123456789" class="h-10 rounded-xl border-slate-200 shadow-none focus-visible:ring-2 focus-visible:ring-slate-900/10" :aria-invalid="!!form.errors.phone" />
                        </div>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                        <div class="flex flex-col gap-2">
                            ...
                            <Select :model-value="String(form.customer_type_id || '')" @update:model-value="(val) => form.customer_type_id = Number(val)">
                                <SelectTrigger class="h-10 rounded-xl border-slate-200 shadow-none focus-visible:ring-2 focus-visible:ring-slate-900/10">
