...
import { index as restockIndex, store } from '@/actions/App/Http/Controllers/RestockController';
...
<AppLayout :breadcrumbs="breadcrumbs">
    <div class="p-6 flex flex-col gap-6">
        <div class="flex items-center gap-4">
            ...
            <div>
                <h1 class="text-2xl font-bold tracking-tight">Catat Restock Baru</h1>
                <p class="text-muted-foreground">Catat bahan baku yang baru dibeli untuk menambah stok produksi.</p>
            </div>
        </div>
        ...
        <form @submit.prevent="submit" class="flex flex-col gap-6">
            ...
            <Card class="border-0 rounded-none shadow-none bg-transparent">
                <CardHeader class="px-0">
                    ...
                    <CardDescription>Pilih tanggal pengadaan dan keterangan (opsional).</CardDescription>
                </CardHeader>
            ...
            <Card class="border-0 rounded-none shadow-none bg-transparent">
                <CardHeader class="px-0 flex flex-row items-center justify-between">
                    <div class="space-y-1">
                        ...
                        <CardDescription>Tambahkan bahan baku berserta jumlah dan harga satuannya.</CardDescription>
                    </div>
